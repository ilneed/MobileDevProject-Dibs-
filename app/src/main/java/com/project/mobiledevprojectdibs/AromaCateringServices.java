 ...
 * Use the {@link AromaCateringServices#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AromaCateringServices extends Fragment {
     ...
     * @return A new instance of fragment AromaCateringServices.
     */
    // TODO: Rename and change types and number of parameters
    public static AromaCateringServices newInstance(String param1, String param2) {
        AromaCateringServices fragment = new AromaCateringServices();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_aroma_catering_services, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.aromaCateringServices,serviceCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.aromaCateringServices, sellerProfileTwo);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.aromaCateringServices,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
