 ...
 * Use the {@link MenTshirt#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenTshirt extends Fragment {
     ...
     * @return A new instance of fragment MenTshirt.
     */
    // TODO: Rename and change types and number of parameters
    public static MenTshirt newInstance(String param1, String param2) {
        MenTshirt fragment = new MenTshirt();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_men_tshirt, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.menTshirt,clothesCategory);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menTshirt, sellerProfileTwo);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menTshirt,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
