 ...
 * Use the {@link MenPants#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenPants extends Fragment {
     ...
     * @return A new instance of fragment MenPants.
     */
    // TODO: Rename and change types and number of parameters
    public static MenPants newInstance(String param1, String param2) {
        MenPants fragment = new MenPants();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_men_pants, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.menPants,clothesCategory);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menPants, sellerProfileThree);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menPants,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
