 ...
 * Use the {@link ChickenBurger#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChickenBurger extends Fragment {
     ...
     * @return A new instance of fragment ChickenBurger.
     */
    // TODO: Rename and change types and number of parameters
    public static ChickenBurger newInstance(String param1, String param2) {
        ChickenBurger fragment = new ChickenBurger();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_chicken_burger, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.chickenBurger,foodCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.chickenBurger, sellerProfileTwo);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.chickenBurger,newOrderInterface);
                transaction.commit();
            }
        });
