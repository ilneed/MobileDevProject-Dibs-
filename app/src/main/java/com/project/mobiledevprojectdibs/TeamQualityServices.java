 ...
 * Use the {@link TeamQualityServices#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TeamQualityServices extends Fragment {
     ...
     * @return A new instance of fragment TeamQualityServices.
     */
    // TODO: Rename and change types and number of parameters
    public static TeamQualityServices newInstance(String param1, String param2) {
        TeamQualityServices fragment = new TeamQualityServices();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_team_quality_services, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.teamQualityServices,serviceCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.teamQualityServices, sellerProfile);
                transaction.commit();
            }
        });
