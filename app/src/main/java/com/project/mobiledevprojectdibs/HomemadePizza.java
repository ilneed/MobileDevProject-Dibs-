 ...
 * Use the {@link HomemadePizza#newInstance} factory method to
 * create an instance of this fragment.
 */
public class HomemadePizza extends Fragment {
     ...
     * @return A new instance of fragment HomemadePizza.
     */
    // TODO: Rename and change types and number of parameters
    public static HomemadePizza newInstance(String param1, String param2) {
        HomemadePizza fragment = new HomemadePizza();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_homemade_pizza, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.homemadePizza,foodCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.homemadePizza, sellerProfileThree);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.homemadePizza,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
