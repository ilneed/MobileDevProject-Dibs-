 ...
 * Use the {@link Spaghetti#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Spaghetti extends Fragment {
     ...
     * @return A new instance of fragment Spaghetti.
     */
    // TODO: Rename and change types and number of parameters
    public static Spaghetti newInstance(String param1, String param2) {
        Spaghetti fragment = new Spaghetti();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_spaghetti, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.spaghetti,foodCategoryy);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.spaghetti,newOrderInterface);
                transaction.commit();
            }
        });
