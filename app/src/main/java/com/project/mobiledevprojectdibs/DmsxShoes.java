 ...
 * Use the {@link DmsxShoes#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DmsxShoes extends Fragment {
     ...
     * @return A new instance of fragment DmsxShoes.
     */
    // TODO: Rename and change types and number of parameters
    public static DmsxShoes newInstance(String param1, String param2) {
        DmsxShoes fragment = new DmsxShoes();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_dmsx_shoes, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.dmsxShoes,clothesCategory);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.dmsxShoes, sellerProfile);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.dmsxShoes,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
