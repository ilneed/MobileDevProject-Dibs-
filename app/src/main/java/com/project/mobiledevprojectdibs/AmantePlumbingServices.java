 ...
 * Use the {@link AmantePlumbingServices#newInstance} factory method to
 * create an instance of this fragment.
 */
public class AmantePlumbingServices extends Fragment {
     ...
     * @return A new instance of fragment AmantePlumbingServices.
     */
    // TODO: Rename and change types and number of parameters
    public static AmantePlumbingServices newInstance(String param1, String param2) {
        AmantePlumbingServices fragment = new AmantePlumbingServices();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_amante_plumbing_services, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.amantePlumbingServices,serviceCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.amantePlumbingServices, sellerProfileTwo);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.amantePlumbingServices,newOrderInterface);
                transaction.commit();
            }
        });
