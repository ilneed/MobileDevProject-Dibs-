 ...
 * Use the {@link MenTankTop#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MenTankTop extends Fragment {
     ...
     * @return A new instance of fragment MenTankTop.
     */
    // TODO: Rename and change types and number of parameters
    public static MenTankTop newInstance(String param1, String param2) {
        MenTankTop fragment = new MenTankTop();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_men_tank_top, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.menTankTop,clothesCategory);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menTankTop, sellerProfileThree);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.menTankTop,newOrderInterface);
                transaction.commit();
            }
        });
        return root;
