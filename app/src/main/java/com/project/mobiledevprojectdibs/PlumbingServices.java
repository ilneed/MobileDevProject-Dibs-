 ...
 * Use the {@link PlumbingServices#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PlumbingServices extends Fragment {
     ...
     * @return A new instance of fragment PlumbingServices.
     */
    // TODO: Rename and change types and number of parameters
    public static PlumbingServices newInstance(String param1, String param2) {
        PlumbingServices fragment = new PlumbingServices();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_plumbing_services, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.plumbingServices,serviceCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.plumbingServices, sellerProfile);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.plumbingServices,newOrderInterface);
                transaction.commit();
            }
        });
