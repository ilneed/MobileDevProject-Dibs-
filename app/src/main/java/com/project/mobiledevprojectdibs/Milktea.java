 ...
 * Use the {@link Milktea#newInstance} factory method to
...
public class Milktea extends Fragment {
     ...
     * @return A new instance of fragment Milktea.
     */
    // TODO: Rename and change types and number of parameters
    public static Milktea newInstance(String param1, String param2) {
        Milktea fragment = new Milktea();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root =  inflater.inflate(R.layout.fragment_milktea, container, false);
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                transaction.replace(R.id.milktea,foodCategoryy);
                transaction.commit();
            }
        });
        ...
        productSeller.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.milktea, sellerProfile);
                transaction.commit();
            }
        });
        ...
        orderButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.milktea,newOrderInterface);
                transaction.commit();
            }
        });
